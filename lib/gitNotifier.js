...
GitNotifier.prototype.buildHtmlDiff = function(ansiTxt) {
    var tabsToSpaces = config.get('tabsToSpaces');
    if (tabsToSpaces) {
    ...
    return '<!doctype html>\n' +
        ...
        '<meta charset="utf-8">' +
        '</head>' +
        '<body style="font-family: courier, monospace; white-space: pre; background-color: #111; color: #aaa; padding: 5px; font-size: 12px">' +
