...
GitNotifier.prototype.sendEmailNotification = function (repoUrl, ansiLogAndDiff, remoteSha1, callback) {
    ...
    // Send email!
    debug("Sending email from=%s to=%s for repo=%s", this.EMAIL_FROM, this.EMAIL_TO, path.basename(repoUrl));
    var mailOptions = {
...
GitNotifier.prototype.buildHtmlDiff = function(ansiTxt) {
    ...
    return '' +
        '<div style="font-family: courier, monospace; white-space: pre; background-color: #000; color: #aaa; padding: 5px">' +
